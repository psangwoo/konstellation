...
[![Go Report Card](https://goreportcard.com/badge/github.com/psangwoo/konstellation)](https://goreportcard.com/report/github.com/psangwoo/konstellation)
[![license](https://img.shields.io/github/license/CosmWasm/wasmd.svg)](https://github.com/psangwoo/konstellation/blob/master/LICENSE)
[![LoC](https://tokei.rs/b1/github/CosmWasm/wasmd)](https://github.com/psangwoo/konstellation)
<!-- [![GolangCI](https://golangci.com/badges/github.com/psangwoo/konstellation.svg)](https://golangci.com/r/github.com/psangwoo/konstellation) -->
...
make test
```
if you are using a linux without X or headless linux, look at [this article](https://ahelpme.com/linux/dbusexception-could-not-get-owner-of-name-org-freedesktop-secrets-no-such-name) or [#31](https://github.com/psangwoo/konstellation/issues/31#issuecomment-577058321).
...
* `-X github.com/psangwoo/konstellation/app.NodeDir=.corald` - set the config/data directory for the node (default `~/.wasmd`)
* `-X github.com/psangwoo/konstellation/app.Bech32Prefix=coral` - set the bech32 prefix for all accounts (default `wasm`)
* `-X github.com/psangwoo/konstellation/app.ProposalsEnabled=true` - enable all x/wasm governance proposals (default `false`)
* `-X github.com/psangwoo/konstellation/app.EnableSpecificProposals=MigrateContract,UpdateAdmin,ClearAdmin` - 
